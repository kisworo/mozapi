...
class Moz {
    ...
    public function linkingRootDomains($target,$target_scope="subdomain",$sort="source_domain_authority",$filter = "external",$begin_date = null,$end_date = null,$limit = 50,$next_token=null) {
